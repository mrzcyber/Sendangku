...
@section('title', 'Create Table - Sendangku')
@section('meta_description', 'Tambah meja restaurant Sendangku.')
  ...
  <main class="flex-1 lg:ml-[280px] flex flex-col bg-muted min-h-screen overflow-x-hidden">
    ...
    <div class="flex-1 overflow-y-auto p-5 md:p-8">
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 class="text-foreground text-2xl font-bold mb-1">Tambah Table</h1>
          <p class="text-secondary text-sm">Buat meja baru untuk order restaurant.</p>
        </div>
      ...
      <form action="{{ route('admin.table.store') }}" method="POST" class="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_360px] gap-6">
        @csrf
          ...
          <div class="p-6 space-y-6">
            <div class="flex flex-col gap-2">
              ...
              <input
                ...
                required
              >
              <p class="text-sm font-medium text-secondary">Kode meja akan dibuat otomatis berdasarkan nomor meja.</p>
              @error('number')
          ...
          <div class="flex flex-col rounded-3xl border border-border bg-white shadow-sm overflow-hidden">
            ...
            <div class="p-6">
              <div class="rounded-2xl bg-muted ring-1 ring-border p-5">
                ...
                <p id="tableCodePreview" class="font-bold text-foreground">MEJA----</p>
