...
@section('meta_description', 'Create a new Sendangku blog article.')
  ...
  <main class="flex-1 lg:ml-[280px] flex flex-col bg-muted min-h-screen overflow-x-hidden">
    ...
    <div class="flex-1 overflow-y-auto p-5 md:p-8">
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 class="text-foreground text-2xl font-bold mb-1">Tambah Blog</h1>
          <p class="text-secondary text-sm">Buat artikel baru untuk halaman blog dan berita Sendangku.</p>
        </div>
      ...
      <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_420px] gap-6">
        @csrf
